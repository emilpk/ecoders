...
import { Mail, MessageCircle, Calendar, MapPin, Clock, ExternalLink, Github, Linkedin, Twitter } from "lucide-react"
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Available for remote projects, consulting, and ongoing maintenance. Let's discuss how I can help bring your
            ideas to life.
          </p>
        </div>
            ...
            <Card className="h-full">
              ...
              <CardContent className="space-y-6">
                <div>
                  ...
                  <a href="mailto:emil@ecoders.dev" className="text-pink-600 hover:text-pink-700 transition-colors">
                    emil@ecoders.dev
                  </a>
                </div>
                ...
                <div>
                  ...
                  <Badge className="bg-green-100 text-green-800">Available for new projects</Badge>
                </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="text-center p-6 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 text-sm mb-4">Book a free 30-minute consultation to discuss your project</p>
          ...
          <Card className="text-center p-6 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 text-sm mb-4">Check out my latest articles on web development and technology</p>
            <Button variant="outline" size="sm">
              <ExternalLink className="h-4 w-4 mr-2" />
              Visit Blog
            </Button>
          ...
          <Card className="text-center p-6 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Quick Question?</h3>
            <p className="text-gray-600 text-sm mb-4">Have a quick question? Send me a direct message</p>
            <Button variant="outline" size="sm">
