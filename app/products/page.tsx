...
//     description:
//       "Complete SaaS starter with authentication, payments, dashboard, and deployment configuration.",
//     expectedPrice: "$99",
...
//     description:
//       "A collection of utilities, code snippets, and templates for modern web development.",
//     expectedPrice: "$49",
//     category: "Coming Soon",
//     features: [
          ...
          <div className="mb-16">
            ...
            {/* <div className="grid md:grid-cols-2 gap-8">
              {upcomingProducts.map((product, index) => (
                <Card
                  key={index}
                  className="h-full hover:shadow-lg transition-shadow border-2 border-purple-200"
                >
                  <CardHeader>
                    <div className="flex justify-between items-start mb-2">
                      <Badge
          ...
          <Card className="p-8 bg-gradient-to-r from-pink-100 to-purple-100">
            <div className="text-center">
              ...
              <p className="text-gray-700 mb-6">
                Be the first to know about new product releases, updates, and
