...
const projects = [
  {
    ...
    description:
      "Lead Developer for the creation of Curtin University's Staff Portal, creating a secure and user-friendly portal for all university staff members to access internal applications, staff resources, internal communication tools, latest staff news and events",
    technologies: ['WordPress', 'PHP', 'TypeScript', 'CSS', 'MySQL'],
  ...
  {
    title: 'University Courses Handbook',
    description:
  ...
  {
    title: 'Satterley Real Estate community intranet',
    description:
...
export const Route = createFileRoute('/projects')({
  head: () => ({
    meta: [
      { title: 'Featured Projects | ecoders.dev' },
      { name: 'description', content: 'A showcase of recent work and successful implementations by Emil Krautmann.' },
      { property: 'og:title', content: 'Featured Projects - Emil Krautmann' },
      { property: 'og:description', content: 'A showcase of recent work and successful implementations' },
      { property: 'og:url', content: 'https://ecoders.dev/projects' },
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-12">
            <Card className="p-8 bg-gradient-to-r from-pink-100 to-purple-100">
              ...
              <a href={`mailto:${myInfo.email}?subject=Ready to start your project`}>
