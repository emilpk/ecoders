...
export const Route = createFileRoute('/about')({
  head: () => ({
    meta: [
      { title: 'About Emil Krautmann | ecoders.dev' },
      { name: 'description', content: 'Passionate developer, entrepreneur, and lifelong learner with 27+ years of web development experience.' },
      { property: 'og:title', content: 'About Emil Krautmann' },
      { property: 'og:description', content: 'Passionate developer, entrepreneur, and lifelong learner' },
      { property: 'og:url', content: 'https://ecoders.dev/about' },
